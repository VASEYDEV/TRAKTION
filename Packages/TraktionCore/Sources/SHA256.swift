/// Pure-Swift SHA-256 (FIPS 180-4), used for stable content identity of source
/// assets. Implemented locally because no cross-platform hash API exists in the
/// standard toolchain (CryptoKit is Apple-only) and the dependency policy in
/// AGENTS.md discourages external packages.
public enum SHA256 {
    ...
    public static func hexDigest(_ input: [UInt8]) -> String {
