...
- Repo-wide rules land in `AGENTS.md`; `CLAUDE.md` is a compatibility shim.
...
- [2026-09-21 integration and testing](2026-09-21-integration-and-testing.md): dependency-preserving integration, current build evidence, release gaps and manual testing checklist.
