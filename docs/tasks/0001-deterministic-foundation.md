...
Base: `main` after Foundation Kit PR #3 (`9d6d77c`)
...
5. Fail closed on duplicate captures, incompatible widths, insufficient evidence, any ambiguous acceptable placement, unsupported axis, invalid plan, or unsafe dimensions.
...
- Production-calibrated exhaustive registration for full-resolution phone captures;
  bounded candidate verification may fail closed on large, weakly discriminated inputs.
...
- Short exact repeated band competing with a longer near-exact overlap
- Unrelated captures
- Width mismatch
- Duplicate capture
...
- A short exact repeated band cannot outrank a longer acceptable placement; the pair
